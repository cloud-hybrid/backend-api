...
import Database.Git.Collections.Tasks.CRUD
...
class HTTP(Request):
    ...
    CRUD = Database.Git.Collections.Tasks.CRUD.Document(__module__.split(".")[1])

    @staticmethod
    @Generator.get("/All",
        name = "Query All Git Configurations",
        response_model = List[Optional[Schema]],
        responses = { 422: {
            "description" : "Type (Schema) Validation Error"
        }}, response_description = "Query Response Return",
        status_code = 200, deprecated = False, summary = "Git C[R]UD (All) Endpoint"
    )
    async def All():
    ...
    @staticmethod
    @Generator.get("/{ID}",
        name = "Query a Git Configuration",
        response_model = Schema,
        responses = { 422: {
            "description" : "Type (Schema) Validation Error"
        }}, response_description = "Query Response Return",
        status_code = 200, deprecated = False, summary = "Git C[R]UD Endpoint"
    )
    ...
    @Generator.post("/Create",
        name = "Create A Git Task Document",
        response_model = Schema,
        responses = { 422: {
            "description" : "Type (Schema) Validation Error"
        }}, response_description = "Query Response Return",
        status_code = 201, deprecated = False, summary = "Git [C]RUD Endpoint"
    )
    ...
    @Generator.put("/Update",
        name = "Mutate A Git Task Document",
        response_model = Schema, responses = { 422: {
            "description" : "Type (Schema) Validation Error"
        }}, response_description = "Query Response Return",
        status_code = 200, deprecated = False, summary = "Git CR[U]D Endpoint"
    )
    ...
    @Generator.delete("/Drop",
        name = "Delete A Git Task Document",
        response_model = Union[Success, Response],
        responses = { 422: {
            "description" : "Type (Schema) Validation Error"
        }}, response_description = "Query Response Return",
        status_code = 200, deprecated = False, summary = "Git CRU[D] Endpoint"
    )
