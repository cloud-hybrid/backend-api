...
import Database.Taskboard.Collections.LinkedResources.CRUD

from Database.Taskboard.Schemas.LinkedResource import (
    Base,
    Create,
    Update,
    Schema,
...
class HTTP(Request):
    ...
    CRUD = Database.Taskboard.Collections.LinkedResources.CRUD.Document()
